...
export default function AddProductPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        price: '',
        stock: '100',
        folder_name: 'default', // Fallback
        color: '#000000',
        bg_gradient: 'bg-gradient-to-b from-slate-950 via-gray-900 to-slate-950'
    });
        ...
        try {
            ...
            const { error } = await supabase
                ...
                .insert({
                    ...
                    formatted_price: `₹${parseFloat(formData.price).toLocaleString()}`, // Approximate formatting
    ...
    return (
        <div className="max-w-2xl mx-auto pb-32"> {/* Increased bottom padding */}
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-xl border border-gray-200 shadow-sm relative z-0">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <label className="cursor-pointer bg-gray-900 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors flex items-center gap-2">
